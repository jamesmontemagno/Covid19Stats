...
namespace Covid19Stats
{
    public static class SettingsService
    {
        ...
        {
            get => AppSettings.GetValueOrDefault(nameof(DirectoryPath), defaultDirectoryPath);
        ...
        {
            get => AppSettings.GetValueOrDefault(nameof(CountryRefreshInterval), 10);
            set => AppSettings.AddOrUpdateValue(nameof(CountryRefreshInterval), value);
        }
    }
